...
\begin{document}
	...
	\setheader{MAT224}{PAR 2}{Due: Week 3 Tutorial (draft), January 25 (final)}{}{Name:\underline{\hspace{2in}}}{}
	...
	Suppose $\vec v_1,\vec v_2,\vec v_3,\vec v_4\in \R^3$.  Let
			...
			$\mathcal Y\subset \mathcal V$ of \emph{size two} is linearly independent.
			Explain what form(s) $\mathrm{rref}(X)$, the reduced row echelon form of $X$, must take in this case.  
