...
\begin{document}
	...
	\setheader{MAT224}{PAR 5}{Due: Week 7/8 Tutorial (draft), March 1 (final)}{}{Name:\underline{\hspace{2in}}}{}
	...
	{\bf Definition 1}: The matrices $A$ and $B$ are called \emph{similar} if they represent the same
	linear transformation but in (possibly) different bases.
	
	{\bf Definition 2}: The matrices $A$ and $B$ are called \emph{similar} if there is an invertible
	matrix $P$ such that $A=PBP^{-1}$.

	\bigskip
	{\bf Problem Statement}\par

	Are definition 1 and definition 2 equivalent, that is, are they saying the same thing? Describe, in your own words, how the two definitions
	relate. Make sure to include a description of what the matrices $P$ and $P^{-1}$ do.
